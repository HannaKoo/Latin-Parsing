#Code for analysing how unanimous the tree different parser models are in regards to POS and UFEATS

import argparse
import sys
from collections import Counter

# giving names to column number order
...
def vote_upos(upos):
    ...
    if v > 1: # if most_common result appears more than once, take it...
        return k
    else:
